...
function AppWrapper() {
  ...
  return (
    <Stack>
      ...
      <Stack.Screen name="components/Exercise/ExerciseCardDisplay" options={{ title: "ExerciseCardDisplay", headerShown: false }} />
      ...
      <Stack.Screen name="components/Client/(tabs)/index" options={{ title: "Client Tabs", headerShown: false }} />
      </Stack>
  );
}
